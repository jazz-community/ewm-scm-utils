...
import com.ibm.js.team.supporttools.framework.util.AbstractUnzip;

/**
 * Unzip and use IStatusCollector for output
 * 
 * 
 */
...
//		public Unzip(File zipFile, File zipRootFolder, IStatusCollector status) {
