...
import com.ibm.js.team.supporttools.framework.util.HeaderRequestInterceptor;
...
public class ExpensiveScenarioService implements IExpensiveScenarioService {
	...
	public static IExpensiveScenarioService createScenarioService(final JazzFormAuthClient client,
		...
		return createScenarioService(client, webContextUrl, "TSM", SupportToolsFrameworkConstants.VERSIONINFO,
				commandName);
	}
